const t=`<!-- <button></button> 태그 사용 -->
<button class="be-button">Contents-text</button>
<!-- <div></div> 태그 사용 -->
<div class="be-button">Contents-text</div>`,n=`// component
...
// component
<BeButton badge={badge} badgeOption={badgeOption}>...</BeButton>`,p="// emit: onClick <BeButton onClick={handleClick}>...</BeButton>",f=`<!-- html -->
<div class="buttons">
...
`;export{n as a,t as b,o as c,s as d,u as e,c as f,b as g,l as h,i,r as j,g as k,h as l,p as m,f as n,B as o,x as p,v as q,d as r,e as s,a as t,m as w};
